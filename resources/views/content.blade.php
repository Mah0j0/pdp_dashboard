               ...
               <div class="-mt-12 mx-6 mb-6 grid grid-cols-1 gap-x-6 gap-y-6 sm:grid-cols-2 xl:grid-cols-4">
                    ...
                    <div class="card shadow dark:bg-gray-800 dark:text-gray-100">
                        ...
                        <div class="card-body dark:bg-gray-800 dark:rounded-md">
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <div class="bg-indigo-600 bg-opacity-10 rounded-md w-10 h-10 flex items-center justify-center text-center text-indigo-600 dark:bg-indigo-500 dark:bg-opacity-20 dark:text-indigo-400">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-tag">
                            ...
                            <div class="mt-4 flex flex-col gap-0 text-base">
                                <h2 class="text-xl font-bold dark:text-gray-100">18</h2>
                                <div>
                ...
                <div class="bg-white shadow rounded-lg p-6 dark:bg-gray-800 dark:text-gray-100">
                    <!-- heading -->
                    <div class="flex justify-between items-center mb-4">
                        <h2 class="text-xl font-semibold text-gray-800 dark:text-gray-100">Projects</hjson>
                    </div>
