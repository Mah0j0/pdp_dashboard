        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Habitaciones</span>
                </a>
            </li>
            @endif
            ...
            <li>
                <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 20">
                        <path d="M17 5.923A1 1 0 0 0 16 5h-3V4a4 4 0 1 0-8 0v1H2a1 1 0 0 0-1 1v10a3 3 0 0 0 3 3h10a3 3 0 0 0 3-3V5.923Zm-6 7.292V15a1 1 0 0 1-2 0v-1.785A3 3 0 1 1 11 10a3.019 3.019 0 0 1-2 3.215ZM6 4a2 2 0 1 1 4 0v1H6Z"/>
                    </svg>
            ...
            <li>
                ...
                <span class="flex-1 ms-3 whitespace-nowrap">Contabilidad</span>
                </a>
            </li>
            @endif
        </ul>
        <ul class="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
            ...
            <li>
                <form method="POST" action="{{ route('logout') }}">
                    ...
                    @csrf
                    <button type="submit" class="flex-1 justify-start">Cerrar sesión</button>
                    </a>
                </form>
            </li>
        </ul>
